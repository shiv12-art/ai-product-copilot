...
export const Alert = React.forwardRef<HTMLDivElement, AlertProps>(
  (
    { type = 'info', title, message, onClose, isDismissible = true, className = '', ...props },
    ref
  ) => {
    ...
    return (
      <div
        ...
        className={`
          ...
          border rounded-lg p-4 flex gap-3 transition-all duration-150
          ${className}
        `}
        {...props}
      >
        <div className={`${styles.icon} flex-shrink-0 mt-0.5`}>{getIcon(type)}</div>
